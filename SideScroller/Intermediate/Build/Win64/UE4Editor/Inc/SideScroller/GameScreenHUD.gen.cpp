...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGameScreenHUD_Statics::NewProp_Timer_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "GameScreenHUD" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "GameScreenHUD.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UGameScreenHUD_Statics::NewProp_Timer = { "Timer", nullptr, (EPropertyFlags)0x002008000008000c, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameScreenHUD, Timer), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGameScreenHUD_Statics::NewProp_Timer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameScreenHUD_Statics::NewProp_Timer_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGameScreenHUD_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGameScreenHUD_Statics::NewProp_Timer,
	};
	...
	IMPLEMENT_CLASS(UGameScreenHUD, 4272384294);
